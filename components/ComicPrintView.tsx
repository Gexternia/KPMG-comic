    ...
    <div className="h-screen w-full overflow-y-auto bg-gray-900 pb-20 print:!h-auto print:!min-h-0 print:!bg-white print:!p-0 print:!pb-0 print:!overflow-visible">
      ...
      >
        ...
        <div className={`min-h-0 min-w-0 border-r-2 border-b-2 border-black relative overflow-hidden ${PRINT_PANEL_BG} p-0 rotate-180`}>
          {comic.cover && <img src={comic.cover} alt="Cover" className="print-ia-cover-stretch z-0" />}
          {/* Print cover title */}
          <div className="absolute bottom-0 left-0 right-0 z-10 pt-3 text-center" style={{ transform: 'rotate(0deg)' }}>
            <div className="text-2xl font-bold text-white uppercase" style={{ fontFamily: "'Bangers', cursive", textShadow: '2px 2px 0 #000, -1px -1px 0 #000' }}>
              KPMG
            </div>
          </div>
        ...
        <div className={`min-h-0 min-w-0 border-b-2 border-black relative overflow-hidden ${PRINT_PANEL_BG} p-0 rotate-180`}>
          {comic.backCover && <img src={comic.backCover} alt="Back Cover" className="print-ia-cover-stretch z-0" />}
          <div className="absolute inset-0 z-10 flex items-center justify-center pointer-events-none">
            <h2 className="text-5xl font-bold text-white" style={{ fontFamily: "'Bangers', cursive", textShadow: '3px 3px 0 #000, -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000' }}>FIN</h2>
          </div>
        </div>
